  ...
  return (
    <section className="rounded-xl border border-slate-200/10 bg-slate-950/60 p-4">
      ...
      <ul className="space-y-2 text-xs text-slate-300">
        {items.length === 0 ? (
          <li className="rounded border border-dashed border-slate-200/15 bg-slate-900/30 p-2 text-slate-500">
            No prompts yet. Start by asking your agent to plan a safe action.
          </li>
        ) : null}
